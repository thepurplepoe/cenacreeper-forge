package cenacreepermod.common.entity.ai;
...
public class EntityAICenaCreeperSwell extends EntityAIBase
{
    ...
    EntityCenaCreeper swellingCreeper;
    /** The creeper's attack target. This is used for the changing of the creeper's state. */
    EntityLivingBase creeperAttackTarget;

    public EntityAICenaCreeperSwell(EntityCenaCreeper entityModCreeper)
    {
    ...
    public void updateTask()
    {
        ...
        else if (this.swellingCreeper.getDistanceSqToEntity(this.creeperAttackTarget) > 255.0D)
        {
            this.swellingCreeper.setCreeperState(-1);
        }
